...
//		if(mainCharacter.score>=60)
//		{
//			mainCharacter.setSpeedX(8);
//		}
//		else if(mainCharacter.score<60)
//		{
...
//				mainCharacter.setSpeedX(4);
//			}
			mainCharacter.setSpeedX((int)mainCharacter.speed);
	...
	public void paint(Graphics g) {
		...
		case GAME_OVER_STATE:
			...
			g.drawString("HI " + (int)mainCharacter.highscore, 500, 20);
			g.drawString("Score " + (int)mainCharacter.score, 500, 40);
			if (gameState == GAME_OVER_STATE) {
//				g.drawString("Score " + mainCharacter.score, 200, 20);
